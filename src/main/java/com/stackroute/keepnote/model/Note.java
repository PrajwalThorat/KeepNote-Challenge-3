...
public class Note {
	...
	public Note(int noteId, String noteTitle, String noteContent, String noteStatus, LocalDateTime createAt,
	...
	public String toString() {
		return "Note [noteId=" + noteId + ", noteTitle=" + noteTitle + ", noteContent=" + noteContent + ", noteStatus="
				+ noteStatus + ", createAt=" + createAt + ", category=" + category + ", reminder=" + reminder
				+ ", createdBy=" + createdBy + "]";
	}
